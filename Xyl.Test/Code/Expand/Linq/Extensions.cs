...
namespace Xyl.Test.Code.Expand.Linq
{
    public static class Extensions
    {
        public static IEnumerable<T> Pagination<T>(this IEnumerable<T> Data, int pageNo, int pageSize)
        {
            return Data.Skip((pageNo - 1) * pageSize).Take(pageSize).ToList();
        }
